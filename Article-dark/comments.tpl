<li class="comment rounded border-bottom pb-4 mb-4">
<div class="thumb"><img src="{foto}" style="width:70px;border-radius:50%" alt="{login}" /></div>
<div class="details">
<div class="float-end">
[rating]
...
<h4 class="name text-white">[profile]{login}[/profile]</h4>
<span class="date">{date}</span>
<div class="mb-3">{comment}</div>
[fast]<span class="btn btn-simple btn-sm">Ответить</span>[/fast]
[com-edit]<span class="btn btn-simple btn-sm">Изменить</span>[/com-edit]
[com-del]<span class="btn btn-simple btn-sm">Удалить</span>[/com-del]
</div>
</li>
